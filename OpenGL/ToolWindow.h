...
namespace OpenGL
{
    ...
    private:
        ...
        void InitializeValues(void)
        {
            ...
            labelSpecularStrength->Text = String::Format("Specular Strength                                    {0:0.00}", SpecularStrength);
            labelSpecularColorR->Text = String::Format("Specular Color R                                    {0:0.00}", SpecularColorR);
            ...
            labelWaterScaleFrequency->Text = String::Format("Frequency                                              {0:0.00}", WaterScaleFrequency);
            labelWaterScaleAmplitude->Text = String::Format("Amplitude                                              {0:0.00}", WaterScaleAmplitude);
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->trackBarWaterScaleFrequency))->BeginInit();
            (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->trackBarWaterScaleAmplitude))->BeginInit();
            this->SuspendLayout();
            ...
            this->buttonResetLightPosition->Click += gcnew EventHandler(this, &ToolWindow::buttonResetLightPosition_Click);
            ...
            this->radioButtonTransform->CheckedChanged += gcnew EventHandler(this, &ToolWindow::radioButtonTransform_CheckedChanged);
            ...
            this->checkBoxTranslate->CheckedChanged += gcnew EventHandler(this, &ToolWindow::checkBoxTranslate_CheckedChanged);
            ...
            this->checkBoxRotate->CheckedChanged += gcnew EventHandler(this, &ToolWindow::checkBoxRotate_CheckedChanged);
            ...
            this->radioButtonWaterScale->CheckedChanged += gcnew EventHandler(this, &ToolWindow::radioButtonWaterScale_CheckedChanged);
            ...
            this->checkBoxWireframeRender->CheckedChanged += gcnew EventHandler(this, &ToolWindow::checkBoxWireframeRender_CheckedChanged);
